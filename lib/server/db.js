...
export const db = {
  ...
  async createFormPage(formId, pageNumber, imageData, metadata = null) {
    let query, params;
    
    if (metadata) {
      query = `
        INSERT INTO form_pages (form_id, page_number, image_data, original_width, original_height, rendered_width, rendered_height, paper_size, orientation, scale, dpi) 
      ...
      params = [
        ...
        metadata.rendered_width,
        metadata.rendered_height,
        metadata.paper_size,
      ...
      query = `
        INSERT INTO form_pages (form_id, page_number, image_data) 
        VALUES ($1, $2, $3) 
        RETURNING *
      `;
      params = [formId, pageNumber, imageData];
    }
  ...
  async saveFormPage(formId, pageNumber, imageData, metadata = null) {
    let query, params;
